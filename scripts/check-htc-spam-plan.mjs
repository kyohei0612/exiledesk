 ...
 *   - 同じ側 (サフィ) の残りは知性・全耐性
 *   - 平均は 170 神前後 (品質 40%・触媒あり)。手で組んだ検算 (197.5 神) は全耐性にトゥル (冷気) しか
 *     試しておらず、雷 (エシュ) の方が付きやすい (雷のタグを持つ MOD が少なく分母が小さい) ぶん安い
 *   - 触媒を全部切ると、スパムの狙いは全耐性 (同じ「使わない」組で一番付きにくいサフィ) になり 500 神前後
...
if (!(e > 160 && e < 185)) fail(`平均 ${e.toFixed(1)} 神 (170 神前後のはず)`);
