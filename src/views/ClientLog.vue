...
import ClientLogHistory from "./ClientLogHistory.vue";
import { mb, num, shortTs } from "./client-log-format";
...
<template>
  <section class="min-h-full block px-6 py-4 bg-[var(--exile-color-bg-canvas)] text-[var(--exile-color-text-primary)]">
    ...
    <!-- 消し込み履歴 (ClientLogHistory.vue へ切り出し 2026-09-26) -->
    <ClientLogHistory :history="history" />
