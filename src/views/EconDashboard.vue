    ...
    <div class="mb-6 p-5 rounded-lg bg-[var(--exile-color-bg-surface)] border border-[var(--exile-color-border-subtle)]">
      ...
      <div class="mb-3 flex gap-2 items-center flex-wrap">
        ...
        <input
          ...
          :step="10"
          :disabled="discoveryLoading"
          class="w-20 px-2 py-1 rounded bg-[var(--exile-color-bg-canvas)] border border-[var(--exile-color-border-subtle)] text-xs font-mono"
        />
        <span class="text-[10px] text-[var(--exile-color-text-secondary)]">/ 最大 {{ MAX_LISTINGS_PER_CYCLE }}</span>
