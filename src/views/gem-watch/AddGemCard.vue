...
<template>
  <BaseCard class="mb-4">
    <div class="p-4 pl-5">
      <h3 class="text-sm font-bold text-amber-100 mb-2"><span class="mr-2 rounded-full bg-amber-500/80 px-2 py-0.5 text-[11px] font-bold text-black">2</span>ジェムを足す</h3>
